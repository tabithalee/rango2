...
import django
django.setup()
from wrango.models import Category, Page

def populate():
    #  1) create lists of dictionaries w pages for each category
    #  2) create dictionary(ies) for categories
    #  allows for iteration through each data structure, then add data to models
    ...
    #Print out categories just added
